...
class MergeSort: public DivideAndConquer<Element>
{
    ...
    protected:
        ...
        //pre: MS is a valid MergeSort instance, and p is a valid vector of
        //  elements
        ...
        //pre: MS is a valid MergeSort instance, and p is a valid vector of
        //  elements.
        //post: p is split in two, and a vector composed of the 2 resulting
        //  vectors is returned
        virtual vector<vector<Element> > decompose(vector<Element> p);

        //pre: MS is a valid MergeSort instance, and p is a valid vector with
        //  size 2 of vectors of elements.
        //post: the two vectors are combined into one vector, and that vector
        //  is returned
